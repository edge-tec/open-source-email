...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Webmail'); ?> - EdgeMail</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="compose-btn-wrap">
            <a href="<?php echo e(route('webmail.compose')); ?>" class="btn-compose">✏️ Compose</a>
        </div>
        <nav class="nav">
            <a href="<?php echo e(route('webmail.inbox')); ?>" class="nav-link <?php echo e(request()->routeIs('webmail.inbox') && !isset($currentFolder) ? 'active' : ''); ?>">
                <span class="nav-link-icon">📥 Inbox</span>
                <?php if(isset($unread) && $unread > 0): ?><span class="badge"><?php echo e($unread); ?></span><?php endif; ?>
            </a>
            ...
            <?php if(isset($folders)): ?>
                <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(strtoupper($f) !== 'INBOX'): ?>
                        <a href="<?php echo e(route('webmail.folder', urlencode($f))); ?>" class="nav-link <?php echo e(isset($currentFolder) && $currentFolder === $f ? 'active' : ''); ?>">
                            <span class="nav-link-icon">📁 <?php echo e($f); ?></span>
                        </a>
                    <?php endif; ?>
        ...
        <div style="padding:1rem;border-top:1px solid var(--border)">
            <a href="<?php echo e(route('webmail.settings')); ?>" class="nav-link <?php echo e(request()->routeIs('webmail.settings') ? 'active' : ''); ?>" style="padding:.5rem">
                <span class="nav-link-icon">⚙️ Settings</span>
            </a>
            <?php if(auth()->user()->isAdmin()): ?>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link" style="padding:.5rem">
    ...
    <main class="main">
        <header class="topbar">
            <form action="<?php echo e(route('webmail.search')); ?>" method="GET" class="search-bar">
                <span>🔍</span>
                <input type="text" name="q" class="search-input" placeholder="Search mail..." value="<?php echo e(request('q')); ?>">
            </form>
            <div class="user-menu">
                <span class="user-email"><?php echo e($mailbox->email); ?></span>
...
<?php /**PATH /var/www/html/resources/views/webmail/layout.blade.php ENDPATH**/ ?>