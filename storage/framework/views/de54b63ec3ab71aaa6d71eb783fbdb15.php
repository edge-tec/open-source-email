...
<?php $__env->startSection('content'); ?>
    ...
    <div class="table-card" style="margin-bottom:1.5rem">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(180px, 1fr));gap:1.5rem;padding:1.5rem">
            <div>
                ...
                <div id="live-cpu" style="font-size:1.5rem;font-weight:700;color:var(--t1)"><?php echo e($systemStats['cpu_load']); ?></div>
            </div>
            <div>
                <div style="font-size:.8rem;color:var(--t2);margin-bottom:.25rem;text-transform:uppercase;font-weight:600">RAM Total</div>
                <div id="live-ram-total" style="font-size:1.5rem;font-weight:700;color:var(--t1)"><?php echo e($systemStats['ram_total'] ? $systemStats['ram_total'] . ' MB' : 'N/A'); ?></div>
            </div>
            <div>
                <div style="font-size:.8rem;color:var(--t2);margin-bottom:.25rem;text-transform:uppercase;font-weight:600">RAM Used</div>
                <div id="live-ram-used" style="font-size:1.5rem;font-weight:700;color:var(--warn)"><?php echo e($systemStats['ram_used'] ? $systemStats['ram_used'] . ' MB' : 'N/A'); ?></div>
            </div>
            <div>
    ...
    <script>
        ...
        function fetchLiveMetrics() {
            fetch('<?php echo e(route("admin.system-metrics")); ?>')
