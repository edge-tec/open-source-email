...
<?php $__env->startSection('content'); ?>
    ...
    <form id="dbForm" action="<?php echo e(route('installer.mail-config')); ?>" method="GET">
        <div class="form-row">
        ...
        <div class="btn-row">
            <a href="<?php echo e(route('installer.permissions')); ?>" class="btn btn-secondary">← Back</a>
...
async function testConnection() {
    ...
    try {
        const result = await apiPost('<?php echo e(route("installer.test-database")); ?>', data);
        if (result.success) {
...
<?php echo $__env->make('installer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/installer/database.blade.php ENDPATH**/ ?>