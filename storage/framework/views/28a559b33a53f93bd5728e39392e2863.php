<?php $__env->startSection('title', 'Installing'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="btn-row" id="completeActions" style="display: none;">
        <span></span>
        <a href="<?php echo e(route('installer.complete')); ?>" class="btn btn-primary">
...
async function runInstallation() {
    ...
    try {
        const result = await apiPost('<?php echo e(route("installer.run")); ?>', config);
...
<?php echo $__env->make('installer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/installer/finalize.blade.php ENDPATH**/ ?>