...
<body>
    ...
    <aside class="sidebar" id="adminSidebar">
        ...
        <div class="sidebar-brand" style="justify-content: center;">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="EdgeMail" style="height: 90px; width: auto; max-width: 200px; object-fit: contain;">
        </div>
    ...
    <main class="main">
        ...
        <nav class="mobile-nav">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">Dashboard</a>
            <a href="<?php echo e(route('admin.domains.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.domains.*') ? 'active' : ''); ?>">Domains</a>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">Users</a>
            <a href="<?php echo e(route('admin.mailboxes.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.mailboxes.*') ? 'active' : ''); ?>">Mailboxes</a>
            <a href="<?php echo e(route('admin.aliases.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.aliases.*') ? 'active' : ''); ?>">Aliases</a>
            <a href="<?php echo e(route('admin.logs.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.logs.*') ? 'active' : ''); ?>">SMTP Logs</a>
            <a href="<?php echo e(route('admin.queue.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.queue.*') ? 'active' : ''); ?>">Queue</a>
            <a href="<?php echo e(route('admin.spam.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.spam.*') ? 'active' : ''); ?>">Spam</a>
            <a href="<?php echo e(route('admin.storage.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.storage.*') ? 'active' : ''); ?>">Storage</a>
            <a href="<?php echo e(route('admin.security.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('admin.security.*') ? 'active' : ''); ?>">Security</a>
            <a href="<?php echo e(route('webmail.inbox')); ?>" class="mobile-nav-link">Webmail</a>
        </nav>
